...
import { writeMarkdownReport } from './write-markdown-report';
...
export async function persistSiteAgentReport(
  ...
  try {
    ...
    return {
      directoryPath: writtenJsonReport.directoryPath,
      jsonReportPath: writtenJsonReport.filePath,
      markdownReportPath: writtenMarkdownReport.filePath
    };
  } catch (error: unknown) {
