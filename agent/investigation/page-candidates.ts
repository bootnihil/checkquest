...
export type PageCandidateReference = `candidate-${number}`;
...
export interface InvestigablePageCandidate extends PageCandidate {
  finding: ExploratoryQaFinding & {
    evidenceTarget: NonNullable<ExploratoryQaFinding['evidenceTarget']>;
  };
}

export function assignPageCandidateReferences(findings: ExploratoryQaFinding[]): PageCandidate[] {
