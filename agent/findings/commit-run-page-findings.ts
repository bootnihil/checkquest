...
import type { PageCandidate, PageCandidateReference } from '../investigation/page-candidates';
import type { PreparedRunPageFindings } from './prepare-run-page-findings';
import type { RunFindingLifecycleState } from './run-finding-lifecycle';
import {
...
export function commitRunPageFindings(
  ...
  /* First run-level mutation: all result and association validation is complete. */
  registerUnifiedPageFindings(
  ...
  /* KF updates follow UR updates so canonical UR verification remains authoritative. */
