...
import {
  requireGeminiApiKey
} from './resolve-gemini-api-key';

const credentialPreflightTimeoutMs =
  10_000;
...
export type GeminiCredentialRejectionKind =
  | 'authentication'
  | 'authorization';
...
function collectStructuredStrings(
  value:
    unknown,
  key:
    string,
...
export async function probeGeminiCredentials(
  input:
