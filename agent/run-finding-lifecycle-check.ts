...
function createEquadorFinding(
  ...
  return {
    ...
    suggestedCheck:
      'Confirm whether the option can be selected.',
    evidenceTarget: {
      kind:
        'select-option',
      controlLabel:
...
function createAnalysis(
  ...
  return {
    findings,
    summary:
      'Synthetic run-level finding lifecycle check.'
  };
}
...
function getInvestigationStatus(
  evidence:
    ReturnType<
      typeof getRunFindings
    >[number]['occurrences'][number]['evidence']
): string | undefined {
  return evidence
    .find(
      item =>
...
function main(): void {
      ...
      exploratoryFindingResults: [
        {
          ...
          outcome: {
            status:
              'verified',
            summary:
              'Equador could be selected.',
            evidence: [
              'The selected option was Equador.'
            ]
          }
        }
      ]
        ...
        exploratoryFindingResults: [
          {
            ...
            outcome: {
              status:
                'inconclusive',
              summary:
                'No conclusive semantic evidence was collected.',
              evidence: []
            }
          }
        ]
  ...
  console.log(
    'Run-level finding lifecycle check passed.'
  );
}
