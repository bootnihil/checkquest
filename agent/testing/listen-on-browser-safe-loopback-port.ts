...
const maximumAllocationAttempts =
  20;
...
async function listenOnEphemeralPort(
  ...
  if (
    ...
    throw new Error(
      'The loopback fixture server did not expose a TCP port.'
    );
  }
...
async function closeRejectedBinding(
  server: Server
): Promise<void> {
  await new Promise<void>(
    (
