...
const desktopRunEventSchemas: Readonly<Record<DesktopRunEvent['type'], z.ZodType>> = {
...
export function projectDesktopRunEvent(value: unknown): DesktopRunEvent | null {
  if (
    typeof value !== 'object' ||
    value === null ||
    !('type' in value) ||
   ...
   */
  return result.data as DesktopRunEvent;
}
...
export function projectDesktopStartRunReply(value: unknown): DesktopStartRunReply {
...
export function projectDesktopCancelRunReply(value: unknown): DesktopCancelRunReply {
